...
class Doctor(models.Model):
    user = models.OneToOneField(settings.AUTH_USER_MODEL, related_name='User_Doctor', verbose_name=_("Doctor"), on_delete=models.CASCADE)
    ...
    review = models.ForeignKey('consultation.Review',related_name="doctor_reviews", verbose_name=_("Review"), on_delete=models.CASCADE , null=True, blank=True)
...
class Hospital(models.Model):
    ...
    admin = models.OneToOneField(settings.AUTH_USER_MODEL, verbose_name=_("Admin"),related_name="hospital_admin" , on_delete=models.CASCADE)
    ...
    review = models.ForeignKey('consultation.Review',related_name="hospital_reviews", verbose_name=_("Review"), on_delete=models.CASCADE, null=True,blank=True)
